...
<body <?php body_class("bg-[#fcfaf7] text-[#333] font-['Montserrat',sans-serif]"); ?>>
    ...
    <nav role="navigation" class="bg-white sticky top-0 z-50 shadow-sm border-b border-gray-50">
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <!-- Desktop Menu -->
            <ul class="hidden lg:flex flex-wrap justify-start items-center lg:ml-12 lg:mr-auto gap-4 md:gap-8 text-[11px] font-bold uppercase tracking-[0.15em] text-gray-600">
                <?php
                $menu_tree = array();
