...
<section class="bg-[#dcd0c0] py-16 text-center">
    <div class="container mx-auto px-4">
        <h2 class="text-4xl md:text-5xl font-['Cormorant_Garamond'] font-medium tracking-widest text-[#2d2a26] mb-4 uppercase"><?php the_title(); ?></h2>
        <div class="flex items-center justify-center space-x-2 text-xs md:text-sm font-bold uppercase tracking-widest text-[#5c4a37]">
            ...
            <span class="text-[#2d2a26] uppercase"><?php the_title(); ?></span>
        </div>
    </div>
</section>
