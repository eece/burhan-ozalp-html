    ...
    'fields' => array(
        array(
            ...
            'layouts' => array(
                ...
                // Layout: Contact Map
                'layout_contact_map' => array(
                    'key' => 'layout_contact_map',
                    'name' => 'contact_map',
                    'label' => 'İletişim Haritası (Map Section)',
                    'display' => 'block',
                    'sub_fields' => array(
                        array(
                            'key' => 'field_map_embed_url',
                            'label' => 'Google Maps Embed URL',
                            'name' => 'embed_url',
                            'type' => 'text',
                            'instructions' => 'Google Haritalar\'dan paylaşılan "Harita yerleştirme" iframe kurgusunun src="..." kısmındaki URL adresini giriniz.',
                            'default_value' => 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3007.8285903936994!2d28.97151247656627!3d41.0727041713419!2m3!1f0!2f0!3f0!3m2!1i1024!2i708!4f13.1!3m3!1m2!1s0x14cab6fca170197d%3A0xa94f715878832a87!2sKordon%20Istanbul!5e0!3m2!1str!2str!4v1700000000000!5m2!1str!2str',
                        ),
                    ),
                ),
                // Layout: Contact Details & Form
                'layout_contact_details_form' => array(
                    'key' => 'layout_contact_details_form',
                    'name' => 'contact_details_form',
                    'label' => 'İletişim Bilgileri ve Form (Details & Form)',
                    'display' => 'block',
                    'sub_fields' => array(
                        array(
                            ...
                            'name' => 'address_title',
                            'type' => 'text',
                            'default_value' => 'MUAYENEHANE ADRESİ',
                        ),
                        array(
                            'key' => 'field_contact_address_text',
                            'label' => 'Adres Detayı',
                            'name' => 'address_text',
                            'type' => 'textarea',
                            'default_value' => 'Hamidiye, Cendere Cad. Kordon İstanbul Güzelyalı Sitesi No: 49, 34038 Kağıthane/İstanbul',
                        ...
                        array(
                            ...
                            'name' => 'email',
                            'type' => 'text',
                            'default_value' => 'info@burhanozalp.com',
                        ),
                        array(
                            ...
                            'name' => 'form_title',
                            'type' => 'text',
                            'default_value' => 'İletişim Formu',
                        ),
                        array(
                            'key' => 'field_contact_form_subtitle',
                            'label' => 'Form Alt Başlığı',
                            'name' => 'form_subtitle',
                            'type' => 'text',
                            'default_value' => 'Merak Ettiğiniz Her Şeyi Sorabilirsiniz',
                        ),
                        array(
