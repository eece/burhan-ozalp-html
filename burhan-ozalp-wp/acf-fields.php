...
acf_add_local_field_group(array(
    ...
    'fields' => array(
                ...
                array(
                    ...
                    'sub_fields' => array(
                        ...
                        array(
                            ...
                            'sub_fields' => array(
                                array(
                                    'key' => 'field_header_sub_sub_title',
                                    'label' => 'Başlık',
                                    'name' => 'title',
                                    'type' => 'text',
                                    'required' => 1,
        ...
        array(
            ...
            'sub_fields' => array(
                array(
                    'key' => 'field_footer_col1_link_title',
                    'label' => 'Link Başlığı',
                    'name' => 'title',
                    'type' => 'text',
                    'required' => 1,
                ...
                array(
                    'key' => 'field_footer_col1_link_url',
                    'label' => 'Link URL / Yol',
                    'name' => 'url',
                    'type' => 'text',
                    'required' => 1,
        ...
        array(
            ...
            'sub_fields' => array(
                array(
                    'key' => 'field_footer_col2_link_title',
                    'label' => 'Link Başlığı',
                    'name' => 'title',
                    'type' => 'text',
                    'required' => 1,
                ...
                array(
                    'key' => 'field_footer_col2_link_url',
                    'label' => 'Link URL / Yol',
                    'name' => 'url',
                    'type' => 'text',
                    'required' => 1,
