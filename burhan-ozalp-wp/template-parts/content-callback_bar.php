    ...
    <div class="container mx-auto px-4">
        <div class="flex flex-col lg:flex-row items-center justify-between gap-6 text-center lg:text-left">
            ...
            <form class="flex flex-wrap items-center gap-4 justify-center">
                <input type="text" placeholder="<?php echo esc_attr__( 'Ad Soyad*', 'burhan-ozalp' ); ?>" class="bg-white border-b border-gray-200 px-4 py-2.5 text-base w-full sm:w-60 focus:outline-none focus:border-[#8b6e4e]">
                <div class="flex items-center bg-white border-b border-gray-200 px-4 py-2.5">
                    <img src="https://flagcdn.com/w20/tr.png" class="w-4 mr-2" alt="TR">
                    <input type="tel" placeholder="<?php echo esc_attr__( 'Telefon*', 'burhan-ozalp' ); ?>" class="text-base w-full sm:w-40 focus:outline-none">
                </div>
                <select class="bg-white border-b border-gray-200 px-4 py-2.5 text-base text-gray-400 focus:outline-none w-full sm:w-40">
