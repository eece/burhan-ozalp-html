<?php
/**
 * The template for displaying archive pages (categories, tags, custom archives, etc.).
...
<section class="bg-[#dcd0c0] py-16 text-center">
    <div class="container mx-auto px-4">
        <h2 class="text-4xl md:text-5xl font-['Cormorant_Garamond'] font-light tracking-widest text-white mb-4 uppercase text-center">
        ...
        <div class="flex items-center justify-center space-x-2 text-xs md:text-sm font-bold uppercase tracking-widest text-[#8b6e4e]">
            ...
            <span>-</span>
            <span class="text-white uppercase"><?php echo strip_tags( get_the_archive_title() ); ?></span>
        </div>
    </div>
</section>
...
<section class="py-24 bg-white text-[#333]">
    <div class="container mx-auto px-4">
        ...
        <?php else : ?>
            <p class="text-[#7b5f43] italic text-lg text-center"><?php echo esc_html__( 'Bu arşivde henüz bir içerik bulunamadı.', 'burhan-ozalp' ); ?></p>
        <?php endif; ?>
