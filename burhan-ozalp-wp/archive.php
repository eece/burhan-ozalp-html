...
<section class="bg-[#dcd0c0] py-6 md:py-16 text-center">
    <div class="container mx-auto px-4">
        <h2 class="text-md md:text-5xl font-['Cormorant_Garamond'] font-medium tracking-widest text-[#2d2a26] uppercase text-center break-words" style="word-break: break-word;">
